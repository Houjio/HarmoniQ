...
from harmoniq.modules.hydro.calcule import get_run_of_river_dam_power,estimation_cout_barrage,estimer_qualite_ecosysteme_futur,estimer_daly_futur,calculer_emissions_et_ressources,get_facteur_de_charge,get_energy
import pandas as pd
import numpy as np
...
class InfraHydro():
    ...
    def _charger_debit(self): #Seulement pour les barrages au fil de l'Eau
        filename_debit = DEBIT_DIR / "Debits_alea.csv"
...
if __name__ == "__main__":
    ...
    infraHydro.apport['dateTime'] = pd.to_datetime(infraHydro.apport["dateTime"])
    infraHydro.apport = infraHydro.apport.set_index('dateTime')
